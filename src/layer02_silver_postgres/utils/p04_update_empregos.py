...
def update_ibge04_empregos(csv_path, layer):
    if layer == "silver":
        ...
        IbgeEmpregos = Table('ibge04_empregos', metadata, autoload_with=engine)
...
if __name__ == "__main__":
    csv_path = r'data\outputs\ibge04_empregos\silver\2025-03-23_17-22-29\ibge04_empregos-2025-03-23_17-22-29.csv'
    layer = "silver"
